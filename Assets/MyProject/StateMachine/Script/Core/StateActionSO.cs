...
[CreateAssetMenu(fileName = "StateActionSO", menuName = "Scriptable Objects/StateActionSO")]
public abstract class StateActionSO : ScriptableObject
{
    public StateAction GetStateAction(StateMachine stateMachine, Dictionary<ScriptableObject, object> createdInstances)
    {
